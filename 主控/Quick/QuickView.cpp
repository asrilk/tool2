...
int CQuickView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	mListmeau.InsertMenu(5, MF_BYPOSITION | MF_POPUP | MF_STRING, (UINT)mListmeau_ZJ.m_hMenu, _T("基础功能"));
	mListmeau_ZJ.AppendMenu(MF_STRING | MF_ENABLED, MENU_高速屏幕, _T("高速屏幕"));
	mListmeau_ZJ.AppendMenu(MF_STRING | MF_ENABLED, MENU_文件管理, _T("文件管理"));
	...
	mListmeau.InsertMenu(17, MF_BYPOSITION | MF_POPUP | MF_STRING, (UINT)mListmeau_khd.m_hMenu, _T("主机管理"));
	...
	mListmeau_khd.AppendMenu(MF_SEPARATOR, NULL);
    //mListmeau_khd.AppendMenu(MF_STRING | MF_ENABLED, MENU_远程交谈, _T("远程交谈"));
	...
	//添加二级菜单
	mListmeau.InsertMenu(31, MF_BYPOSITION | MF_POPUP | MF_STRING, (UINT)mListmeau_copy.m_hMenu, _T("复制数据"));
