...
#if _DEBUG
#define TITLENAME  _T("DEBUG Planet Rat");
#else
#define TITLENAME  _T("Planet Rat ");
#endif
...
#include "C:\Users\Administrator\Desktop\winos\Source\XTToolkitPro.h"    // Xtreme Toolkit Pro components
#include "macros.h"
#include "zlib.h"
#include "ipc.h"				//日志使用
